...
/*
 * @(#)EmpleadoNotFoundException.java Created on 22/03/2014, 05:47:41 PM
 *
...
/**
 * Class EmpleadoNotFoundException
 *
...
public class EmpleadoNotFoundException extends Exception {
     ...
     */
    public EmpleadoNotFoundException(String msj) {
        super(msj);
    }
     ...
     */
    public EmpleadoNotFoundException(String msj, Throwable causa) {
        super(msj, causa);
    }
